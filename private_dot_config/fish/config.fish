status is-interactive; and begin
    ...
    abbr --add --set-cursor -- poweroff 'systemctl poweroff'
    abbr --add --set-cursor -- r reset
    abbr --add --set-cursor -- reboot 'systemctl reboot'
    abbr --add --set-cursor -- restart 'systemctl reboot'
    abbr --add --set-cursor -- rs 'rsync --verbose --info=progress2'
    abbr --add --set-cursor -- s ssh
    abbr --add --set-cursor -- sc systemctl
    abbr --add --set-cursor -- scp 'systemctl poweroff'
    abbr --add --set-cursor -- scr 'systemctl reboot'
    abbr --add --set-cursor -- scs 'systemctl --system'
    abbr --add --set-cursor -- scsd 'systemctl --system disable'
    abbr --add --set-cursor -- scsdn 'systemctl --system disable --now'
    abbr --add --set-cursor -- scse 'systemctl --system reenable'
    abbr --add --set-cursor -- scsen 'systemctl --system reenable --now'
    abbr --add --set-cursor -- scsld 'systemctl --system list-dependencies'
    abbr --add --set-cursor -- scsls 'systemctl --system list-sockets'
    abbr --add --set-cursor -- scslt 'systemctl --system list-timers'
    abbr --add --set-cursor -- scslu 'systemctl --system list-units'
    abbr --add --set-cursor -- scsluf 'systemctl --system list-unit-files'
    abbr --add --set-cursor -- scsm 'systemctl --system mask'
    abbr --add --set-cursor -- scsr 'systemctl --system restart'
    abbr --add --set-cursor -- scsrr 'systemctl --system reload-or-restart'
    abbr --add --set-cursor -- scss 'systemctl --system status'
    abbr --add --set-cursor -- scssh 'systemctl --system show'
    abbr --add --set-cursor -- scst 'systemctl --system stop'
    abbr --add --set-cursor -- scsu 'systemctl --system unmask'
    ...
    abbr --add --set-cursor -- tt 'tailscale set'
    abbr --add --set-cursor -- tu 'tailscale up'
    abbr --add --set-cursor -- tuu 'sudo tailscale up --reset --qr --ssh --advertise-exit-node --accept-routes --login-server=https://ts.bjork.tech --operator=$USER --auth-key=%'
    abbr --add --set-cursor -- tw 'tailscale switch'
