...
status is-interactive; and begin
    ...
    abbr --add --set-cursor -- ch chezmoi
    abbr --add --set-cursor -- cha 'chezmoi add'
    abbr --add --set-cursor -- chaf 'chezmoi add --follow'
    abbr --add --set-cursor -- chc 'chezmoi cat'
    abbr --add --set-cursor -- chcd 'chezmoi cd'
    abbr --add --set-cursor -- chd 'chezmoi diff'
    abbr --add --set-cursor -- chdoc 'chezmoi doctor'
    abbr --add --set-cursor -- che 'chezmoi edit'
    abbr --add --set-cursor -- chew 'chezmoi edit --watch'
    abbr --add --set-cursor -- chey 'chezmoi edit --apply'
    abbr --add --set-cursor -- chg 'chezmoi git'
    abbr --add --set-cursor -- chi 'chezmoi init'
    abbr --add --set-cursor -- chia 'chezmoi init --apply'
    abbr --add --set-cursor -- chiad 'chezmoi init --apply https://git.bjork.tech/myned/dotfiles'
    abbr --add --set-cursor -- chm 'chezmoi merge'
    abbr --add --set-cursor -- chma 'chezmoi merge-all'
    abbr --add --set-cursor -- chs 'chezmoi status'
    abbr --add --set-cursor -- cht 'chezmoi chattr --recursive'
    abbr --add --set-cursor -- chtn 'chezmoi chattr --recursive noprivate,noreadonly'
    abbr --add --set-cursor -- chu 'chezmoi update'
    abbr --add --set-cursor -- chx 'chezmoi execute-template'
    abbr --add --set-cursor -- chy 'chezmoi apply'
    abbr --add --set-cursor -- d 'sudo docker'
    abbr --add --set-cursor -- dc 'sudo docker compose'
    abbr --add --set-cursor -- dcd 'sudo docker compose down'
    abbr --add --set-cursor -- dce 'sudo docker compose exec'
    abbr --add --set-cursor -- dcl 'sudo docker compose logs'
    abbr --add --set-cursor -- dcp 'sudo docker compose pull'
    abbr --add --set-cursor -- dcu 'sudo docker compose up'
    abbr --add --set-cursor -- dcuf 'sudo docker compose up --force-recreate'
    abbr --add --set-cursor -- dd 'sudo dd if=% of= status=progress'
    abbr --add --set-cursor -- de 'sudo docker exec'
    abbr --add --set-cursor -- dei 'sudo docker exec --interactive'
    abbr --add --set-cursor -- deit 'sudo docker exec --interactive --tty'
    abbr --add --set-cursor -- det 'sudo docker exec --tty'
    abbr --add --set-cursor -- di 'sudo docker images'
    ...
    abbr --add --set-cursor -- dk 'sudo docker kill'
    abbr --add --set-cursor -- dn 'sudo docker network'
    abbr --add --set-cursor -- dnl 'sudo docker network ls'
    abbr --add --set-cursor -- dp 'sudo docker pull'
    abbr --add --set-cursor -- dps 'sudo docker ps'
    abbr --add --set-cursor -- dpsa 'sudo docker ps --all --size'
    abbr --add --set-cursor -- dpsf 'sudo docker ps --format='\''table {{.ID}}\t{{.Names}}\t{{.Status}}'\'''
    abbr --add --set-cursor -- dr 'sudo docker rm'
    abbr --add --set-cursor -- ds 'sudo docker system'
    abbr --add --set-cursor -- dsp 'sudo docker system prune'
    abbr --add --set-cursor -- dspav 'sudo docker system prune --all --volumes'
    ...
    begin
        ...
        set fish_complete_path $prev "/home/myned/.local/share/fish/home-manager_generated_completions" $post
    end
